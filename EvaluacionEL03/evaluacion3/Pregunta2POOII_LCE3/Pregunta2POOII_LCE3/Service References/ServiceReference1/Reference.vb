...
Namespace ServiceReference1
    ...
    Public Interface IService1
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/IService1/listarNombres", ReplyAction:="http://tempuri.org/IService1/listarNombresResponse")>  _
        Function listarNombres() As System.Data.DataSet
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/IService1/listarNombres", ReplyAction:="http://tempuri.org/IService1/listarNombresResponse")>  _
        Function listarNombresAsync() As System.Threading.Tasks.Task(Of System.Data.DataSet)
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/IService1/listarBoletasXNombre", ReplyAction:="http://tempuri.org/IService1/listarBoletasXNombreResponse")>  _
        Function listarBoletasXNombre(ByVal codigo As String) As System.Data.DataSet
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/IService1/listarBoletasXNombre", ReplyAction:="http://tempuri.org/IService1/listarBoletasXNombreResponse")>  _
        Function listarBoletasXNombreAsync(ByVal codigo As String) As System.Threading.Tasks.Task(Of System.Data.DataSet)
    End Interface
    ...
    Partial Public Class Service1Client
        ...
        Public Function listarNombres() As System.Data.DataSet Implements ServiceReference1.IService1.listarNombres
            Return MyBase.Channel.listarNombres
        End Function
        
        Public Function listarNombresAsync() As System.Threading.Tasks.Task(Of System.Data.DataSet) Implements ServiceReference1.IService1.listarNombresAsync
            Return MyBase.Channel.listarNombresAsync
        End Function
        
        Public Function listarBoletasXNombre(ByVal codigo As String) As System.Data.DataSet Implements ServiceReference1.IService1.listarBoletasXNombre
            Return MyBase.Channel.listarBoletasXNombre(codigo)
        End Function
        
        Public Function listarBoletasXNombreAsync(ByVal codigo As String) As System.Threading.Tasks.Task(Of System.Data.DataSet) Implements ServiceReference1.IService1.listarBoletasXNombreAsync
            Return MyBase.Channel.listarBoletasXNombreAsync(codigo)
        End Function
    End Class
End Namespace
